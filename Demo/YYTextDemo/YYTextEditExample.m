...
- (void)viewDidLoad {
    ...
    if ([toolbar isKindOfClass:[UIVisualEffectView class]]) {
        ...
        [toolVisualEffectiView.contentView addSubview:label];
    } else {
    ...
    if ([toolbar isKindOfClass:[UIVisualEffectView class]]) {
        UIVisualEffectView *toolVisualEffectiView = (UIVisualEffectView *)toolbar;
        [toolVisualEffectiView.contentView addSubview:_verticalSwitch];
    } else {
    ...
    if ([toolbar isKindOfClass:[UIVisualEffectView class]]) {
        UIVisualEffectView *toolVisualEffectiView = (UIVisualEffectView *)toolbar;
        [toolVisualEffectiView.contentView addSubview:_debugSwitch];
    } else {
    ...
    if ([toolbar isKindOfClass:[UIVisualEffectView class]]) {
        UIVisualEffectView *toolVisualEffectiView = (UIVisualEffectView *)toolbar;
        [toolVisualEffectiView.contentView addSubview:_exclusionSwitch];
    } else {
